...
namespace DemoStore_Admin.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        {
            var details = db.Details.Include(o => o.Order).Include(o => o.Product);
        ...
        public ActionResult Details(int? id)
        {
            ...
            OrderDetail orderDetail = db.Details.Find(id);
            if (orderDetail == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderId,ProductId,Quantity,Price")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
